...
We start at boot which is at `0X50000`, we add the kernel which starts add `0x190000` and we get the rootfs offset of: `0x1E0000`. The size is already in the given line which is `0x200000`.
